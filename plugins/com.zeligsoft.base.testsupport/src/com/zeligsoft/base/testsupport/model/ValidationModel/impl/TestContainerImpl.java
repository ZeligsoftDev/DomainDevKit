 ...
 * <ul>
 *   <li>{@link com.zeligsoft.base.testsupport.model.ValidationModel.impl.TestContainerImpl#getTests <em>Tests</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestContainerImpl extends EObjectImpl implements TestContainer {
	...
	protected EClass eStaticClass() {
		return ValidationModelPackage.Literals.TEST_CONTAINER;
	}
	...
	public EList<UnitTest> getTests() {
		if (tests == null) {
			tests = new EObjectContainmentEList<UnitTest>(UnitTest.class, this, ValidationModelPackage.TEST_CONTAINER__TESTS);
		}
		return tests;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValidationModelPackage.TEST_CONTAINER__TESTS:
