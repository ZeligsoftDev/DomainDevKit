...
public class RemoveFromDeployPaneAction
		extends Action
	 ...
	 * @param view
	 */
	public RemoveFromDeployPaneAction(Viewer viewer, DeploymentView view) {
		super();
		setText(DeploymentEditorMessages.DeploymentFormPage_RemoveDlg);
		this.view = view;
		this.viewer = viewer;
		...
		if (viewer.getSelection() instanceof IStructuredSelection) {
			...
			try {
				...
				Activator
						.getDefault()
						.error(
								DeploymentEditorMessages.RemoveFromDeployPaneActionHandler_UndeployErrorMsg,
								e);
			}
		}
	}
