 ...
 * @generated
 */
public class GenDomainModelImpl extends GenDomainPackageImpl implements
		GenDomainModel {
			...
			if (ownedObjects == null) {
				cache.put(
						...
						ownedObjects = new DerivedUnionEObjectEList<GenDomainObject>(
								...
								ZDLGenPackage.GEN_DOMAIN_MODEL__OWNED_OBJECT,
	...
	protected static final int[] OWNED_OBJECT_ESUBSETS = new int[] {
			ZDLGenPackage.GEN_DOMAIN_MODEL__ELEMENT,
			...
			if (domainModel != oldDomainModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ZDLGenPackage.GEN_DOMAIN_MODEL__DOMAIN_MODEL,
	...
	public void setNsURI(String newNsURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__NS_URI, oldNsURI, nsURI));
	}
	...
	public void setRootPackage(String newRootPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__ROOT_PACKAGE,
	...
	public void setImplementationSubPackage(String newImplementationSubPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__IMPLEMENTATION_SUB_PACKAGE,
					oldImplementationSubPackage, implementationSubPackage));
	}
	...
	public void setImplSuffix(String newImplSuffix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__IMPL_SUFFIX, oldImplSuffix,
					implSuffix));
	}
	...
	public void setApiProject(String newApiProject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__API_PROJECT, oldApiProject,
					apiProject));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPalette(GenPalette newPalette,
			NotificationChain msgs) {
		GenPalette oldPalette = palette;
		palette = newPalette;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, ZDLGenPackage.GEN_DOMAIN_MODEL__PALETTE,
	...
	public void setPalette(GenPalette newPalette) {
		if (newPalette != palette) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__PALETTE, newPalette,
					newPalette));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMenuModel(GenMenuModel newMenuModel,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__MENU_MODEL, oldMenuModel,
					newMenuModel);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMenuModel != menuModel) {
			...
			if (menuModel != null)
				msgs = ((InternalEObject) menuModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- ZDLGenPackage.GEN_DOMAIN_MODEL__MENU_MODEL,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ZDLGenPackage.GEN_DOMAIN_MODEL__MENU_MODEL, newMenuModel,
					newMenuModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwningGenModel(GenModel newOwningGenModel,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newOwningGenModel,
				ZDLGenPackage.GEN_DOMAIN_MODEL__OWNING_GEN_MODEL, msgs);
		return msgs;
	}
	...
	public void setOwningGenModel(GenModel newOwningGenModel) {
		if (newOwningGenModel != eInternalContainer()
				|| (eContainerFeatureID() != ZDLGenPackage.GEN_DOMAIN_MODEL__OWNING_GEN_MODEL && newOwningGenModel != null)) {
			...
			if (newOwningGenModel != null)
				msgs = ((InternalEObject) newOwningGenModel).eInverseAdd(this,
						ZDLGenPackage.GEN_MODEL__OWNED_MODEL, GenModel.class,
						msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case ZDLGenPackage.GEN_DOMAIN_MODEL__OWNING_GEN_MODEL:
			return eInternalContainer().eInverseRemove(this,
					ZDLGenPackage.GEN_MODEL__OWNED_MODEL, GenModel.class, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ZDLGenPackage.GEN_DOMAIN_MODEL__NS_URI:
			return NS_URI_EDEFAULT == null ? nsURI != null : !NS_URI_EDEFAULT
					.equals(nsURI);
		case ZDLGenPackage.GEN_DOMAIN_MODEL__ROOT_PACKAGE:
			return ROOT_PACKAGE_EDEFAULT == null ? rootPackage != null
					: !ROOT_PACKAGE_EDEFAULT.equals(rootPackage);
		case ZDLGenPackage.GEN_DOMAIN_MODEL__IMPLEMENTATION_SUB_PACKAGE:
			return IMPLEMENTATION_SUB_PACKAGE_EDEFAULT == null ? implementationSubPackage != null
					: !IMPLEMENTATION_SUB_PACKAGE_EDEFAULT
							.equals(implementationSubPackage);
		case ZDLGenPackage.GEN_DOMAIN_MODEL__IMPL_SUFFIX:
			return IMPL_SUFFIX_EDEFAULT == null ? implSuffix != null
					: !IMPL_SUFFIX_EDEFAULT.equals(implSuffix);
		case ZDLGenPackage.GEN_DOMAIN_MODEL__API_PROJECT:
			return API_PROJECT_EDEFAULT == null ? apiProject != null
					: !API_PROJECT_EDEFAULT.equals(apiProject);
		case ZDLGenPackage.GEN_DOMAIN_MODEL__PALETTE:
			return palette != null;
		case ZDLGenPackage.GEN_DOMAIN_MODEL__MENU_MODEL:
	...
	public boolean isSetOwnedObjects() {
		return super.isSetOwnedObjects()
				|| eIsSet(ZDLGenPackage.GEN_DOMAIN_MODEL__PALETTE);
	}
	...
	public boolean isSetOwner() {
		return super.isSetOwner()
				|| eIsSet(ZDLGenPackage.GEN_DOMAIN_MODEL__OWNING_GEN_MODEL);
	}
	...
	public void setDomainPackage(org.eclipse.uml2.uml.Package newDomainPackage) {
		if (newDomainPackage != null && !(newDomainPackage instanceof Model)) {
			throw new IllegalArgumentException(String.valueOf(newDomainPackage));
		}
