...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gen Domain Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class GenDomainAttributeImpl extends GenDomainStructuralFeatureImpl
	 ...
	 * @ordered
	 */
	protected GenDomainDataType type;
	 ...
	 * @generated
	 */
	protected GenDomainAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZDLGenPackage.Literals.GEN_DOMAIN_ATTRIBUTE;
	}
	 ...
	 */
	@Override
	public GenDomainDataType getType() {
	 ...
	 * @generated
	 */
	public GenDomainDataType basicGetType() {
		return type;
	}
	 ...
	 */
	@Override
	public void setType(GenDomainDataType newType) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ZDLGenPackage.GEN_DOMAIN_ATTRIBUTE__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ZDLGenPackage.GEN_DOMAIN_ATTRIBUTE__TYPE:
			setType((GenDomainDataType) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ZDLGenPackage.GEN_DOMAIN_ATTRIBUTE__TYPE:
			setType((GenDomainDataType) null);
			return;
		}
