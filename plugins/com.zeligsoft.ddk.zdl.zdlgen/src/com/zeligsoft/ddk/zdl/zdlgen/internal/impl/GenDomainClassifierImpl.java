...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gen Domain Classifier</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class GenDomainClassifierImpl extends GenDomainNamedElementImpl
	 ...
	 * @generated
	 */
	protected GenDomainClassifierImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZDLGenPackage.Literals.GEN_DOMAIN_CLASSIFIER;
	}
	 ...
	 */
	@Override
	public void setBlock(GenDomainBlock newBlock) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ZDLGenPackage.GEN_DOMAIN_CLASSIFIER__BLOCK:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetBlock((GenDomainBlock) otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ZDLGenPackage.GEN_DOMAIN_CLASSIFIER__BLOCK:
			setBlock((GenDomainBlock) newValue);
			return;
		}
