...
public class LangCSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LangCPackage.ENUM: {
				com.zeligsoft.cx.langc.Enum enum_ = (com.zeligsoft.cx.langc.Enum)theEObject;
			...
			case LangCPackage.SYSTEM: {
				com.zeligsoft.cx.langc.System system = (com.zeligsoft.cx.langc.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseEnum(com.zeligsoft.cx.langc.Enum object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSystem(com.zeligsoft.cx.langc.System object) {
		return null;
	}
