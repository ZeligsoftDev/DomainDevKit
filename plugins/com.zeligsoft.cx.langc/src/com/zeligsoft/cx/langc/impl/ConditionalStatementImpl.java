 ...
 * <ul>
 *   <li>{@link com.zeligsoft.cx.langc.impl.ConditionalStatementImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalStatementImpl extends CodeBlockImpl implements ConditionalStatement {
	...
	public boolean write(CodeWriter code) {
		return code.write( "if( " ) //$NON-NLS-1$
			&& this.getCondition().write( code )
			&& code.write( " )\n" ) //$NON-NLS-1$
			&& super.write( code );
	}
