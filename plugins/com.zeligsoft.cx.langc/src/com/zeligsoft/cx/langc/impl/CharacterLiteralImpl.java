 ...
 * <ul>
 *   <li>{@link com.zeligsoft.cx.langc.impl.CharacterLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterLiteralImpl extends LiteralImpl implements CharacterLiteral {
	...
	protected EClass eStaticClass() {
		return LangCPackage.Literals.CHARACTER_LITERAL;
	}
	...
	public void setValue(char newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LangCPackage.CHARACTER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LangCPackage.CHARACTER_LITERAL__VALUE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case LangCPackage.CHARACTER_LITERAL__VALUE:
				setValue(((Character)newValue).charValue());
				return;
		}
	...
	public boolean write(CodeWriter code) {
		return code.write( '\'' )
			&& code.write(Character.toString(getValue()))
			&& code.write( '\'' );
	}
