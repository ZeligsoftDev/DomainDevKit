 ...
 * <ul>
 *   <li>{@link com.zeligsoft.cx.langc.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return LangCPackage.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LangCPackage.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LangCPackage.STRING_LITERAL__VALUE:
				return getValue();
		}
	...
	public ElementReference basicGetType() {
		if (type == null) {
			...
			bit.setType(PrimitiveType.CHAR);
