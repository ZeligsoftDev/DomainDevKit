...
public class LangCPackageImpl extends EPackageImpl implements LangCPackage {
	 ...
	 * @see com.zeligsoft.cx.langc.LangCPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getElementList_Types() {
	...
	public EReference getElementList_PrivateDirectives() {
		return (EReference)elementListEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCodeBlob_MarkerComment() {
		return (EAttribute)codeBlobEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDependencyBlob_MarkerComment() {
		return (EAttribute)dependencyBlobEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getLinkableArtifact_Name() {
		return (EAttribute)linkableArtifactEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getLinkableArtifact_FunctionImplementations() {
		return (EReference)linkableArtifactEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(elementListEClass, ELEMENT_LIST__TYPES);
		...
		createEAttribute(codeBlobEClass, CODE_BLOB__MARKER_COMMENT);

		dependencyEClass = createEClass(DEPENDENCY);

		dependencyBlobEClass = createEClass(DEPENDENCY_BLOB);
		createEAttribute(dependencyBlobEClass, DEPENDENCY_BLOB__TEXT);
		createEAttribute(dependencyBlobEClass, DEPENDENCY_BLOB__MARKER_COMMENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getElementList_Types(), this.getElement(), null, "types", null, 0, -1, ElementList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(enumEClass, com.zeligsoft.cx.langc.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnum_Enumerators(), this.getEnumerator(), null, "enumerators", null, 0, -1, com.zeligsoft.cx.langc.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(systemEClass, com.zeligsoft.cx.langc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_SubSystems(), this.getSubSystem(), null, "subSystems", null, 0, -1, com.zeligsoft.cx.langc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_PublicFolders(), this.getFolderName(), null, "publicFolders", null, 0, -1, com.zeligsoft.cx.langc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Artifacts(), this.getLinkableArtifact(), null, "artifacts", null, 0, -1, com.zeligsoft.cx.langc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCodeBlob_MarkerComment(), ecorePackage.getEString(), "markerComment", null, 0, 1, CodeBlob.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDependencyBlob_MarkerComment(), ecorePackage.getEString(), "markerComment", null, 0, 1, DependencyBlob.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLinkableArtifact_Name(), ecorePackage.getEString(), "name", null, 0, 1, LinkableArtifact.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(operatorEEnum, Operator.ASSIGN_ADD);
