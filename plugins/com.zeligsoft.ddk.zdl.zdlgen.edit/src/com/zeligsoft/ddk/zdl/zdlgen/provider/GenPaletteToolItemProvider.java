...
/**
 * This is the item provider adapter for a {@link com.zeligsoft.ddk.zdl.zdlgen.GenPaletteTool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenPaletteToolItemProvider extends GenPaletteItemItemProvider
	 ...
	 * @generated
	 */
	public GenPaletteToolItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenPaletteTool.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((GenPaletteTool) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_GenPaletteTool_type") : //$NON-NLS-1$
				getString("_UI_GenPaletteTool_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
