 ...
 * @generated
 */
public class GenDomainDataTypeItemProvider extends
	...
	protected void addDomainDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_GenDomainDataType_domainDataType_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_GenDomainDataType_domainDataType_feature", "_UI_GenDomainDataType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ZDLGenPackage.Literals.GEN_DOMAIN_DATA_TYPE__DOMAIN_DATA_TYPE,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/GenDomainDataType")); //$NON-NLS-1$
	}
