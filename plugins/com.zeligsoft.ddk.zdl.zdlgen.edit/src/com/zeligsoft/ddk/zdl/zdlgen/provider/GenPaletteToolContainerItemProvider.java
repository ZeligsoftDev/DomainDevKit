 ...
 * @generated
 */
public class GenPaletteToolContainerItemProvider extends
		GenPaletteItemItemProvider implements IEditingDomainItemProvider,
	...
	protected void addToolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_GenPaletteToolContainer_tool_feature"), //$NON-NLS-1$
				getString("_UI_GenPaletteToolContainer_tool_description"), //$NON-NLS-1$
				ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__TOOL, true,
				false, true, null,
	...
	protected void addTargetDiagramPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__TARGET_DIAGRAM,
						true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__OWNED_TOOL);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/GenPaletteToolContainer")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__OWNED_TOOL,
	...
	protected Command createAddCommand(EditingDomain domain, EObject owner,
		...
		if (feature == ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__OWNED_TOOL) {
			return new SubsetAddCommand(
					...
					owner,
					feature,
					new EStructuralFeature[] { ZDLGenPackage.Literals.GEN_PALETTE_TOOL_CONTAINER__TOOL },
					collection, index);
		}
		return super
