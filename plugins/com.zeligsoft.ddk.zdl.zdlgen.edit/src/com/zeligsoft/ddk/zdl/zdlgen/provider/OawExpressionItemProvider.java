...
/**
 * This is the item provider adapter for a {@link com.zeligsoft.ddk.zdl.zdlgen.OawExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OawExpressionItemProvider extends ExpressionItemProvider implements
	 ...
	 * @generated
	 */
	public OawExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns OawExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((OawExpression) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_OawExpression_type") : //$NON-NLS-1$
				getString("_UI_OawExpression_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
