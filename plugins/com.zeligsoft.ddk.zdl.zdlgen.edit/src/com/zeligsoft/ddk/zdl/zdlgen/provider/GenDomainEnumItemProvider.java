...
/**
 * This is the item provider adapter for a {@link com.zeligsoft.ddk.zdl.zdlgen.GenDomainEnum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenDomainEnumItemProvider extends GenDomainDataTypeItemProvider
	 ...
	 * @generated
	 */
	public GenDomainEnumItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenDomainEnum.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((GenDomainEnum) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_GenDomainEnum_type") : //$NON-NLS-1$
				getString("_UI_GenDomainEnum_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
