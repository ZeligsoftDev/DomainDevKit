...
public class GenerateOperation implements IRunnableWithProgress {
	 ...
	 */
	public static String zdlgen2umlprofile_workflow = "workflows/generateUMLProfile.oaw"; //$NON-NLS-1$

	public static String SOURCE_MODEL_URI = "sourceModelURI"; //$NON-NLS-1$
	public static String TARGET_PROFILE_URI = "targetProfileURI"; //$NON-NLS-1$
	public static String SPECIALIZATION_NAME = "specialization"; //$NON-NLS-1$

	public static String TARGET_MODEL_LIBRARY_URIS = "targetModelLibraryURIs"; //$NON-NLS-1$
	...
	public GenerateOperation(Shell shell, Map<String, String> properties, String workflowFile) {
		this(shell, properties, null, workflowFile);
	}
	
	public GenerateOperation(Shell shell, Map<String, String> properties, Map<String, Object> slots, String workflowFile) {
		super();
		this.shell = shell;
